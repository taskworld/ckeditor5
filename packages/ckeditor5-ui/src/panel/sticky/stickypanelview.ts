...
export default class StickyPanelView extends View {
	...
	private _checkIfShouldBeSticky(): void {
		...
		let limiterRect: DOMRect | undefined;
		...
		if ( this.isSticky ) {
			this._isStickyToTheLimiter = limiterRect ? (
				limiterRect.bottom < panelRect.height + this.limiterBottomOffset + viewportTopOffset ) : false;
